...
describe('total likes', () => {
  ...
  test('when list has multiple blogs equals the likes of them all', () => {
...
describe('favorite blog', () => {
  ...
  test('return null with empty list', () => {
...
describe('most blogs', () => {
  ...
  test('when list has only one blog equals the author and amount of that', () => {
...
describe('most likes', () => {
  ...
  test('when list has only one blog equals the author and likeamount of that', () => {
